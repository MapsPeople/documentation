...
* On Mapbox fixed a `NoSuchElementException` crash that could occur when a location was selected while the map style was reloading or a view annotation was being detached.
