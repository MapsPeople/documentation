...
* Fixed 2D Models potentially being displayed incorrectly when same image used for several 2D Models of differing sizes.
...
* Decreased loading times with between 20% and 65%, compared to 4.15.7 and 4.10.0 respectively. This is most notable on large MapsIndoors solutions.
