...
* Removed potential race conditions when starting up MApsIndoors with Mapbox 11, that could cause some of the MApsIndoors data to be displayed incorrectly, e.g. a route using the `DirectionsRenderer`.
