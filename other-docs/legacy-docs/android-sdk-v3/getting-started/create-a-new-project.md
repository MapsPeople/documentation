...
### Set Up Your Environment[​](https://docs.mapsindoors.com/getting-started/android/v3/new-project#set-up-your-environment) <a href="#set-up-your-environment" id="set-up-your-environment"></a>
...
You can get started in two ways, either by reviewing and modifying the [basic example](https://docs.mapsindoors.com/getting-started/android/v3/new-project#basic-example) or do the [clean setup](https://docs.mapsindoors.com/getting-started/android/v3/new-project#setup-mapsindoors). We recommend following the basic example.

### Basic Example[​](https://docs.mapsindoors.com/getting-started/android/v3/new-project#basic-example) <a href="#basic-example" id="basic-example"></a>
...
### Setup MapsIndoors[​](https://docs.mapsindoors.com/getting-started/android/v3/new-project#setup-mapsindoors) <a href="#setup-mapsindoors" id="setup-mapsindoors"></a>
