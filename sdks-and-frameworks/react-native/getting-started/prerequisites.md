...
**Get Your Google Maps API key**[**​**](https://docs.mapsindoors.com/getting-started/React%20Native/prerequisites#get-your-google-maps-api-key)
...
{% tab title="Mapbox" %}
**Get your Mapbox Access Token**[**​**](https://docs.mapsindoors.com/getting-started/React%20Native/prerequisites#get-your-mapbox-access-token)
