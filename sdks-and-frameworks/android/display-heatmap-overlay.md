...
### Creating a heatmap​ <a href="#creating-a-heatmap" id="creating-a-heatmap"></a>
...
### Inserting the heatmap layer between MapsIndoors layers​ <a href="#inserting-the-heatmap-layer-between-mapsindoors-layers" id="inserting-the-heatmap-layer-between-mapsindoors-layers"></a>
