...
{% hint style="info" %}
On newer versions of android studio this preset has been moved. You can instead choose an empty folder and inside you package you can right click and choos **New -> Google -> Google Maps Activity**. It is explained in google maps documentation here [Create a Google Maps project in Android Studio](https://developers.google.com/maps/documentation/android-sdk/start#create-project)
{% endhint %}
