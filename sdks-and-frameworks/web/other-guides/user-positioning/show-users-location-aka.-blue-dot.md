...
If the user has granted permission indefinitely, the map will pan to the current position when reloading the app _(this may not work in certain browsers, such as Internet Explorer 11, due to missing support of the_ [_Permissions API_](https://developer.mozilla.org/en-US/docs/Web/API/Permissions_API)_)_.
